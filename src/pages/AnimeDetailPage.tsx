                                    ...
                                    <div className="space-y-2 text-sm">
                                        {anime.anyo && (
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-black">{anime.anyo}</span>
                                            </div>
                                        )}
                                        {anime.temporada && (
                                            <div className="flex justify-between">
                                                <span className="text-gray-600">Temporada:</span>
                                                <span className="font-medium text-cyan-50">{anime.temporada}</span>
                                            </div>
                                        )}
                                        {anime.genero && (
                                            <div className="flex justify-between">
                                                <span className="text-gray-600">Género:</span>
                                                <span className="font-medium text-gray-500">{anime.genero}</span>
                                            </div>
                                        )}
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Reseñas:</span>
                                            <span className="font-medium text-gray-500">{totalResenyas}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Votaciones:</span>
                                            <span className="font-medium text-gray-500">{votacionesCount}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
