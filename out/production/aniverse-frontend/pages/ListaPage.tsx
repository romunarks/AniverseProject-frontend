...
const CreateListaModal: React.FC<{
    isOpen: boolean;
    onClose: () => void;
    onSuccess: () => void;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <p className="text-gray-600 mb-4">
                    Modal de creación de lista - implementaremos esto después
                </p>
                <div className="flex gap-3">
                    ...
                    <button
                        onClick={onSuccess}
                        className="flex-1 px-4 py-2 bg-aniverse-purple text-white rounded-lg hover:bg-aniverse-purple-dark"
                    >
                        Crear
                    </button>
                </div>
